 ...
 *   },
 *   field_ui_base_route = "bibliography.settings"
 * )
 */
class Bibliography extends ContentEntityBase implements BibliographyInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Bibliography entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Bibliography entity.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Bibliography is published.'))
