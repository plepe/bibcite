...
/**
 * Provides route for delete multiple entities.
 */
class DeleteMultipleRouterProvider implements EntityRouteProviderInterface {
  ...
  protected function deleteMultipleFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('delete-multiple-form')) {
      ...
      $route->setDefault('_form', '\Drupal\bibcite_entity\Form\DeleteMultiple');
